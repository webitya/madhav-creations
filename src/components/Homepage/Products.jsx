...
const Card= (prop) => {
    ...
    return(
        <div className="relative overflow-hidden  " onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
            <div className=" h-80 py-32" style={{
            ...
            <div className="h-80 w-full bg-indigo-600 py-32 absolute top-0 flex justify-center" style={{
...
export const Products = () => {
    return (
        <div className="px-6 flex flex-col gap-4 mb-52">
            <h2 className="text-3xl text-white capitalize font-bold leading-10 py-1 px-3 bg-gradient-to-r from-indigo-500  rounded-tl-xl">
                our products
            </h2>
            <div className="gap-8 grid md:grid-cols-4 grid-cols-1">
